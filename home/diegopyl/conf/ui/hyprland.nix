...

{
  ...
  wayland.windowManager.hyprland = with colors; {
    ...
    extraConfig = ''
      ...
      exec = hyprctl dispatch exec "sleep 5s && vencorddesktop"
      exec = swaybg -i ~/.wallpapers/${wallpaper} &
      exec = dunst &
      ...
      windowrulev2 = opacity 0.9 override 0.9 override, class:^(VencordDesktop)$
      windowrulev2 = workspace special:chat silent, class:^(VencordDesktop)$
