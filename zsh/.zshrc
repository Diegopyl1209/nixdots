...
export PATH="$HOME/.local/bin:$HOME/.spicetify:$HOME/go/bin:$HOME/bin:$HOME/.cargo/bin:$HOME/.yarn/bin:$HOME/.config/hypr/scripts:$PATH"
export HYPRSHOT_DIR="/home/diegopyl/Imágenes"
